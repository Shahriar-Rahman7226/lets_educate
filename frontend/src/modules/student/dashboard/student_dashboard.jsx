...
const StudentDashboard = () => {
  ...
  const handleReviewSubmit = () => {
    if (studentData.completed_sessions < 3) {
      setReviewMessage(
        "You need to complete at least 3 sessions to write a review."
      );
    } else {
      ...
      <section className="student-dashboard-section">
        ...
        <div className="review-section">
          ...
          <p className="review-description">
            Share your experience after completing your
            tutoring sessions.
          </p>
          ...
          <textarea
            ...
            rows="5"
            disabled={studentData.completed_sessions < 3}
          />

          <button
            className={`submit-review-btn ${
              studentData.completed_sessions >= 3
                ? "active-btn"
                : "disabled-btn"
            }`}
            disabled={studentData.completed_sessions < 3}
