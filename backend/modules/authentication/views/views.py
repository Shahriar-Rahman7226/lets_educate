    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            if instance.check_password(serializer.validated_data['password']):
                ...
                data['is_profile_completed'] = instance.is_profile_completed
                data['is_education_completed'] = instance.is_education_completed
...
class ForgetPasswordViewSet(ModelViewSet):
    ...
    def get_forget_password_mail(self, request, *args, **kwargs):
        ...
        # Prepare email
        subject = "SlightEdge Academics: Password Reset Link"
        message = (
